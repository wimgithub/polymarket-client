#!/usr/bin/env python3
"""
Generate PROXY-mode CLOB v2 golden vectors using py-clob-client-v2.

Despite the filename, this is not a builder-relayer/gasless submit vector.
It verifies CLOB v2 signing/request data with SignatureTypeV2.POLY_PROXY.
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        default="testdata/golden/py-clob-client-v2/clob_order_v2_proxy.json",
    )
    ...
    try:
        ...
        output = {
            ...
            "name": "clob_order_v2_proxy_limit_buy_gtc",
            "generatedBy": {
                "sdk": "py-clob-client-v2",
                "script": "scripts/generate_golden_vectors/generate_relayer_proxy.py",
            },
            "input": {
                "privateKey": args.private_key,
                "chainId": args.chain_id,
                "tokenId": args.token_id,
                "signatureType": int(SignatureTypeV2.POLY_PROXY),
                "funder": args.funder,
                "owner": args.owner,
